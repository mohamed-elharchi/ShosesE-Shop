...
<body class="bod">
    ...
    <div class="container">
        <div class="navigation">
            <ul>
                <li>
                    <a href="">
                        <span class="logoo"><img src="image/logoo.jpg" alt="" width="100%" height="70%"></span>
    ...
    <!-- info dash -->
            ...
            <div class="txt-allmessages">Edit page </div>
      ...
      <h2>Edit Product</h2>
            ...
            <form  method="post" >
               <table class="tabb">
                  <tr>
                     ...
                     <td> 
                        <input class="inputt" type="text" name="tit" placeholder="Tile of product" required>
                     </td>
                  </tr>
                  <tr>
                     <td>
                     ...
                     <td>
                        <input class="inputt" type="text" name="pri" placeholder="dh" required>
                     </td>
                  </tr>
                  <tr>
                     <td>
                     ...
                     <td>
                        <input class="inputt" type="text" name="kha" placeholder="dh" required>
                     </td>
                  </tr>
                  ...
                  <tr>
                     ...
                     <td class="ttd">
                        <input class="inputt" type="file" id="file" name="ima" placeholder="Product pictures" required style="display: none">
       ...
       if(isset($_POST['ddde'])){
        include 'connexion.php';
        $iddd=$_GET['idproduct'];
        if(isset($_POST['tit']) && isset($_POST['pri']) && isset($_POST['kha']) && isset($_POST['ima']) && isset($_POST['typ'])){
             $sql="UPDATE article SET title=? ,prix=? ,khasm=? ,image=? ,typee=?  WHERE idproduct=?";
             $req=$db->prepare($sql);
             $req->execute(array($_POST["tit"],$_POST["pri"],$_POST["kha"],$_POST["ima"],$_POST["typ"], $iddd));
             if($req){
