    ...
    <style>
        ...
        *{
		...
		.leftt{
            ...
            flex-direction:column ;
            color: white;
            background:-webkit-linear-gradient(to right, #DF2C62, #DF2C45);
            background:linear-gradient(to right,#DF2C62, #DF2C45);
            margin: 20px;
            box-shadow: 
...
<body class="bod">
            ...
            <div class="topbar">
                ...
                <div class="search">
                    <form action="" method="post">
                        <label for="">
                            <input type="text" placeholder="Search Here" name="search" class="find" onkeyup="search()">
    ...
    <!-- info dash -->
            ...
            <div class="txt-allmessages">All Messages</div>
            ...
            <div class="msg">
                ...
                <div class="cartP">
                    ...
                    <div class="imagee"><img src="image/<?php echo $donnees["image"] ?>" alt="produ"></div>
                    <div class="infoProduct">
                        <div class="title"><span class="s1">Title:</span class="s2"><span class="s2"><?php echo $donnees["title"] ?></span></div>
                        <div class="prix"><span class="s1">Prix:</span><span class="s2"><?php echo $donnees["price"] ?></span><span class="s2">dh</span></div>
                        <div class="typee"><span class="s1">Type:</span class="s2"><span class="s2"><?php echo $donnees["type"] ?></span> </div>
                    </div>

                    <div class="btn">
                        <button class="btn-red "><a href="deleteP.php?id=<?=$donnees['id']?>" onclick="return confirm('etes-vous sur devouloir supprimer cet enregistrement?')">Delete</a></button>
